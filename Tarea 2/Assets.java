...
public class Assets {
    ...
    public static BufferedImage playerChoque1;
    public static BufferedImage playerChoque3;
    ...
    public static void init(){
        ...
        playerChoque3 = spritesheet.crop(7*80, 8*80, 80, 80);
        vidas = spritesheet.crop(10*80, 10*80, 2*80, 2*80);
        //playerChoque1 = spritesheet2.crop(1024-7*80, 8*80, 80, 80);
